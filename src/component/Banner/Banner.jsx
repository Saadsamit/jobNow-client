      ...
      <div className="hero-content text-center text-neutral-content">
        <div className="max-w-lg">
          ...
          <form className="flex sm:flex-row flex-col text-[#071952] rounded-lg items-center sm:gap-0 gap-4" onSubmit={e=> e.preventDefault()}>
            <input type="text" className="sm:w-9/12 w-full py-3 px-2 sm:rounded-s-lg rounded-lg sm:rounded-none outline-none border-2 sm:border-none border-[#0B666A]" placeholder="Our Newspaper"/>
