    ...
    <>
      <footer className="footer p-10 bg-[#35A29F] text-white">
        <aside>
          ...
          <p>
          315/7, ulan road, west rampura, 1219
            <br />
            Dhaka
          </p>
        </aside>
        <nav>
          ...
          <a className="link link-hover" href="mailto:abc@gmail.com">abc@gmail.com</a>
          <a className="link link-hover" href="tel:+880 115 033 8042">+880 115 033 8042</a>
        </nav>
        <nav>
